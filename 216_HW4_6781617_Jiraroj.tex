...
using the given theorem (class material), the distanec ($D$)
  between point $(x_1, y_1, z_1)$ and the plane $ax + by + cz
  -d = 0$ is
  \[
  \begin{aligned}
  D &= \frac{\lvert ax_1 + by_1 + cz_1 - d \rvert}{\sqrt{a^2 +
  b^2 + c^2}} \\
  &= \frac{\lvert 4(3) + (-6)(-2) + 1(7) - 5 \rvert}{\sqrt{4^2
  + (-6)^2 + 1^2}} \\
  &= \frac{\lvert 12 + 12 + 7 - 5 \rvert}{\sqrt{16 + 36 + 1}}
  \\
  &= \boxed{\frac{26}{\sqrt{53}}\
  \text{unit}}
  \end{aligned}
  \]
